/*
    ...
    SPDX-FileCopyrightText: 2026 FluidSur Project
...
Faces.CompactSensorFace {
    ...
    Layout.minimumWidth: horizontalFormFactor ? Math.max(contentItem.preferredWidth, defaultMinimumSize) : defaultMinimumSize
